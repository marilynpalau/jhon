...
5. cd <installdir>/bin/bbb

6. Now you are ready to run the demo programs in the 
    <installdir>/bin/bbb directory
...
10. Configuration for java applications
   ...
   cp libjnisgfplib.so.3.7.0.fdu03_rename libjnisgfplib.so.3.7.0
   make uninstall install

   Configuration for Hamster IV
   cd <install_dir>/lib/linux
   cp libjnisgfplib.so.3.7.0.fdu04_rename libjnisgfplib.so.3.7.0
   make uninstall install

   Configuration for Hamster PRO 20
   cd <install_dir>/lib/linux
   cp libjnisgfplib.so.3.7.0.fdu05_rename libjnisgfplib.so.3.7.0
   make uninstall install
